...
void HAL_SAI_TxHalfCpltCallback(SAI_HandleTypeDef *hsai)
{
  if(hsai == &hsai_BlockA2)
  {
    ...
    {
      Audio.Decode.Out_Buffer[Temp * 2]     = Fragment1[Temp1];
      Audio.Decode.Out_Buffer[Temp * 2 + 1] = Fragment1[Temp1];
    ...
    for(Temp = 0; Temp < Audio_Buffer_Sample_Point / 2; Temp++)
    {
      Audio.Decode.Out_Buffer[Temp * 2]     = Audio_Sin_Data[Temp];
      Audio.Decode.Out_Buffer[Temp * 2 + 1] = Audio_Sin_Data[Temp];
    }
#endif
  }
}
