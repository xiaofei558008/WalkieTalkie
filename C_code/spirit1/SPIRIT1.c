...
#if 0
#define SPIRIT1_CS_Delay_Time       100
...
#else
#define SPIRIT1_CS_Delay_ms         1

#define SPIRIT1_Dealy_ms(x)         HAL_Delay(SPIRIT1_CS_Delay_ms);

#define SPIRIT1_SPI_CS_H()          {SPIRIT1_Dealy_ms(SPIRIT1_CS_Delay_ms);                                \
                                     HAL_GPIO_WritePin(SPIRIT1_CSn_Port, SPIRIT1_CSn_Pin, GPIO_PIN_SET);   \
                                    }

#define SPIRIT1_SPI_CS_L()          {HAL_GPIO_WritePin(SPIRIT1_CSn_Port, SPIRIT1_CSn_Pin, GPIO_PIN_RESET); \
                                     SPIRIT1_Dealy_ms(SPIRIT1_CS_Delay_ms);                                \
                                    }
#endif
